...
;Selection Text
LOGIN_TITLE           DB "DIGITAL LIBRARY - LOGIN $"
LOGIN_MENU_ADMIN      DB "  PRESS 1  TO LOGIN AS OWNER $"
LOGIN_MENU_USER       DB "  PRESS 2  TO LOGIN AS USER $"
LOGIN_MENU_EXIT       DB "  PRESS 0  TO EXIT $"
...
admin_login proc
    admin_login_retry:
        ...
        print_string login_menu_admin
        gap
        print_string login_menu_user
        gap
        print_string login_menu_exit
        gap
        gap
        ...
        cmp al, 1
        JE admin_login_set_admin
        cmp al, 2
        JE admin_login_set_user
        cmp al, 0
        JE admin_login_exit
        
        ERROR_INPUT
        jmp admin_login_retry
        
    admin_login_set_admin:
        mov is_admin, 1
        jmp admin_login_done
        
    admin_login_set_user:
        mov is_admin, 0
        jmp admin_login_done
